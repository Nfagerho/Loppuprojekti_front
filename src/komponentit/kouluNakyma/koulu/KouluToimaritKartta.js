...
class KouluToimaritKartta extends Component {
...
//Datan mappaus
    render() {
        ...
        var toimeksiantooliot = this.state.toimeksiantodata.map((toimeksiantomappi) => {
            ...
            // if (toimeksiantomappi.sijainen === null && toimeksiantomappi.vahvistus === false && toimeksiantomappi.koulu.koulunId === this.props.match.params.id) {
                if (toimeksiantomappi.sijainen === null && toimeksiantomappi.vahvistus === false && toimeksiantomappi.koulu.kouluId == this.props.match.params.id) {
...
export default withAuthorization(condition)(KouluToimaritKartta);